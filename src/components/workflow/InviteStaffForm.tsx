...
export function InviteStaffForm() {
  ...
  return (
    <Card className="p-5">
      <span className="font-mono text-[11px] uppercase tracking-wide text-ink/45">Invite a staff member</span>
      <p className="mt-1 font-body text-xs text-ink/50">
        They&apos;ll receive an email with a link to set up their own password — no temporary password to share.
      </p>
